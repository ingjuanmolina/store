//TODO: Update tests mocking repositories
...
//            service.getPurchaseOrder(Collections.singletonList(invalidEntry));
//        });
//
...
//        Order order = service.getPurchaseOrder(Collections.singletonList(oneApple));
//
...
//        Order order = service.getPurchaseOrder(Arrays.asList(oneApple, oneOrange));
//
...
//        Order order = service.getPurchaseOrder(Arrays.asList(twoApples, threeOranges));
//
//        assertEquals(2, order.getItems().size());
//
//        BaseGood apple = new Apple();
...
//            service.getPurchaseOrder(Arrays.asList(onePositiveEntry, oneNegativeEntry));
//        });
//
